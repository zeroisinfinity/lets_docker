...
```bash
   cd "/home/sahil/gitt_premises/lets_docker/no_copy_test/mount-1.0" 
   zip -r "/home/sahil/gitt_premises/lets_docker/no_copy_test/updated_zip/project_playground.zip" "Project_playground"
```
